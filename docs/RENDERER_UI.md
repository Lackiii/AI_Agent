...
| `/page/pet` | `features/pet/DesktopPetPage.tsx` | 桌宠渲染页（仅桌宠透明窗口使用）；气泡 + 多情绪换脸（`onEmotion`） |
...
| `/page/screenshots` | `features/screenshots/ScreenshotsPage.tsx` | 截图轨迹：立即截图、定时采集、框选 OCR 范围、OCR/画面摘要、关键词检索、删除 |
